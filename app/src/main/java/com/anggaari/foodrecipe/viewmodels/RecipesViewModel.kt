...
import com.anggaari.foodrecipe.data.DataStoreRepository
import com.anggaari.foodrecipe.data.MealAndDietType
...
import com.anggaari.foodrecipe.utils.Constants.Companion.DEFAULT_RECIPES_NUMBER
...
import com.anggaari.foodrecipe.utils.Constants.Companion.QUERY_SEARCH
...
class RecipesViewModel @Inject constructor(
    ...
    fun showNetworkStatus() {
        if (!networkStatus) {
            Toast.makeText(getApplication(), R.string.no_internet_connection, Toast.LENGTH_SHORT)
                .show()
            saveBackOnline(true)
